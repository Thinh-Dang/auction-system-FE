...
const products = [
  ...
  {id: '5', img: './images/products/antiqueclock.png', productName: 'Roman Clock', year: 1192, type: 'Clocks', price: 123, bids: 16, endDate: '2022-12-30'},
]
const Homepage = () => {
  return (
    <main className='text-body-2 flex flex-col gap-[10rem]'>
      <HeroBanner />
      {/* <SearchSection /> */}
      <ProductsSection 
